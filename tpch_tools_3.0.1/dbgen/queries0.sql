-- using 1724158428 as a seed to the RNG
...
where
	...
	and p_size in (9, 23, 1, 35, 3, 40, 43, 28)
...
create view revenue0 (supplier_no, total_revenue) as
	...
	from
		lineitem
	where
		l_shipdate >= date '1996-02-01'
		and l_shipdate < date '1996-02-01' + interval '3' month
	group by
		l_suppkey;
